 ...
 */
public class SortNextFragment extends BaseFragment {


    @BindView(R.id.lv_left_next)
    ListView mLvLeftNext;
    @BindView(R.id.expendlist_next)
    ExpandableListView mExpendlistNext;
    ...
    public SortNextFragment() {
        // Required empty public constructor
    }

    @Override
    protected View initView(LayoutInflater inflater, ViewGroup container) {
        return inflater.inflate(R.layout.fragment_sort_next, container, false);
    }
    ...
    protected void initListener() {
        ...
        mLvLeftNext.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
...
//                posi = position;
        ...
        mLvLeftNext.setOnScrollListener(new AbsListView.OnScrollListener() {
            @Override
    ...
    protected void initData() {
        ...
        mLvLeftNext.setAdapter(mSortNowLeftAdapter);
    ...
    private void initRightData(List<SortBean.DataBean.CategoriesBean> dataBean) {
        ...
        mExpendlistNext.setAdapter(mSortNowRightAdapter);
        //去掉指示图片
        mExpendlistNext.setGroupIndicator(null);
        //遍历所有group,将所有项设置成默认展开
        int count = mExpendlistNext.getCount();
        for (int i=0; i<count; i++)
        {
            mExpendlistNext.expandGroup(i);
        }
    }
